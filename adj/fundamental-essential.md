# Topic: Fundamental, Essential

| **Hebrew**    | **Transcription** | **Meaning**               | **Notes**                                                                   | **Example**                                                       |
| ------------- | ----------------- | ------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| **עֶקְרוֹנִי**   | *ekroní*          | fundamental, principled    | From *עיקרון* (principle); moral, ideological, rule-based connotation.      | **עמדה עקרונית** – a principled stance                            |
